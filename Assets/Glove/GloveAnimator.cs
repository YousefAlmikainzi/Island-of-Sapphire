...
public class GloveAnimator : MonoBehaviour
{
    ...
    enum GloveAnimLoopType { NONE, IDLE, WALK, GRAB_IDLE, GRAB_WALK };
    ...
    {
        if (currentLoop == GloveAnimLoopType.IDLE) return;
    ...
    {
        if (currentLoop == GloveAnimLoopType.WALK) return;
    ...
    {
        currentLoop = GloveAnimLoopType.NONE;
        ...
        currentRotTweenL = PrimeTween.Tween.LocalRotation(leftGlove.transform, pushStartRotL, transitionAnimTime, ease: PrimeTween.Ease.InSine).OnComplete(
            () =>
            {
                ...
                currentRotTweenL = PrimeTween.Tween.LocalRotation(leftGlove.transform, pushEndRotL, pushAnimTime, ease: PrimeTween.Ease.InSine);
            }
        );
    }
    ...
    public void PlayGrab()
    {
        ...
        currentRotTweenL = PrimeTween.Tween.LocalRotation(leftGlove.transform, grabStartRotL, transitionAnimTime, ease: PrimeTween.Ease.InSine).OnComplete(
            () =>
            {
                ...
                currentRotTweenL = PrimeTween.Tween.LocalRotation(leftGlove.transform, grabEndRotL, grabAnimTime, ease: PrimeTween.Ease.InSine);
            }
        );
    }
    ...
    {
        if (currentLoop == GloveAnimLoopType.GRAB_IDLE) return;
    ...
    {
        if (currentLoop == GloveAnimLoopType.GRAB_WALK) return;
    ...
    public void PlayThrow()
    {
        ...
        currentRotTweenL = PrimeTween.Tween.LocalRotation(leftGlove.transform, throwStartRotL, transitionAnimTime, ease: PrimeTween.Ease.Linear).OnComplete(
            () =>
            {
                ...
                currentRotTweenL = PrimeTween.Tween.LocalRotation(leftGlove.transform, throwEndRotL, throwAnimTime, ease: PrimeTween.Ease.Linear);
            }
        );
    }
